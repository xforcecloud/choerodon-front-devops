...
const pageDetail = {
  ...
  'env.token.description': '您好，您的环境申请已经提交，请耐心等候...',
  'env.token.link': `${docServer}/user-guide/deployment-pipeline/environment-pipeline/`,
  'env.key.title': '环境"{name}"的申请状态',
  'env.key.description': '您好，您的环境申请已经提交，请耐心等候...',
...
const zhCN = {
  ...
  'envPl.code.copy.tooltip': '您好，您的环境申请已经提交，请您耐心等候...',
  ...
  'envPl.token.application.status': '申请状态',
